...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/css.gg/icons/all.css":[function(require,module,exports) {
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/notyf/notyf.min.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"style/index.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"../../node_modules/css.gg/icons/all.css":"../node_modules/css.gg/icons/all.css","../../node_modules/materialize-css/dist/css/materialize.css":"../node_modules/materialize-css/dist/css/materialize.css","../../node_modules/notyf/notyf.min.css":"../node_modules/notyf/notyf.min.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/date-and-time/date-and-time.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/**
...
function dateFormatter(dateString) {
  var pattern = _dateAndTime.default.compile('ddd, D/MM HH.mm');

  return _dateAndTime.default.format(new Date(dateString), pattern);
}

function showLoading(data) {
  var load = document.querySelector('.load'); // default state
...
},{"date-and-time":"../node_modules/date-and-time/date-and-time.js"}],"config.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.headers = exports.standing = exports.baseurl = void 0;
var authToken = '5b1b442446754fbb8547ca7860b68860';
var baseurl = 'https://api.football-data.org/v2/';
exports.baseurl = baseurl;
var standing = "".concat(baseurl, "competitions/2021/standings");
...
exports.fetchDetailTeam = fetchDetailTeam;
exports.fetchMatchTeam = fetchMatchTeam;
...
function fetchStandings() {
  return new Promise(function (resolve, reject) {
    if ('caches' in window) {
      caches.match(_config.standing).then(function (response) {
        if (response) {
          return response.json();
        }
    ...
    ajax(_config.standing, _config.headers).then(function (response) {
      return resolve(response);
    }).catch(function (error) {
      return reject(error);
    });
...
function fetchDetailTeam(id) {
  return new Promise(function (resolve, reject) {
    if ('caches' in window) {
      caches.match("".concat(_config.baseurl, "teams/").concat(id)).then(function (response) {
        if (response) {
          return response.json();
        }
      }).then(function (result) {
    ...
    ajax("".concat(_config.baseurl, "teams/").concat(id), _config.headers).then(function (response) {
      return resolve(response);
    }).catch(function (error) {
      return reject(error);
    });
...
function fetchMatchTeam(id) {
  return new Promise(function (resolve, reject) {
    if ('caches' in window) {
      caches.match("".concat(_config.baseurl, "teams/").concat(id, "/matches?status=SCHEDULED")).then(function (response) {
        if (response) {
          return response.json();
        }
      }).then(function (result) {
    ...
    ajax("".concat(_config.baseurl, "teams/").concat(id, "/matches?status=SCHEDULED"), _config.headers).then(function (response) {
      return resolve(response);
    }).catch(function (error) {
      return reject(error);
    });
...
},{"./config":"config.js"}],"controllers/FootballCtrl.js":[function(require,module,exports) {
"use strict";
...
var FootballController = /*#__PURE__*/function () {
  function FootballController() {
    _classCallCheck(this, FootballController);
  ...
  _createClass(FootballController, [{
    key: "fetchDataCompetition",
    value: function fetchDataCompetition() {
      var _this = this;

      return new Promise(function (resolve, reject) {
        (0, _api.fetchStandings)().then(function (response) {
          // showing loading indicator progress
          (0, _helper.showLoading)(response);
          _this.data.competition = response.competition;
          _this.data.season = response.season;
          _this.data.standing = response.standings[0];
          resolve(_this.data);
        }).catch(function (error) {
          return reject(error);
        });
    ...
    key: "fetchDataTeam",
    value: function fetchDataTeam(id) {
      var _this2 = this;

      return new Promise(function (resolve, reject) {
        Promise.all([(0, _api.fetchDetailTeam)(id), (0, _api.fetchMatchTeam)(id)]).then(function (response) {
          // showing loading indicator progress
          (0, _helper.showLoading)(response);
          _this2.data.teams = response[0]; // filter data pemain berdasarkan posisinya

          _this2.data.teams.filteredSquad = {
            goalkeeper: [],
            defender: [],
            midfielder: [],
            attacker: [],
          ...
          _this2.data.teams.squad.forEach(function (item) {
            if (item.position === 'Goalkeeper') _this2.data.teams.filteredSquad.goalkeeper.push(item);
            if (item.position === 'Defender') _this2.data.teams.filteredSquad.defender.push(item);
            if (item.position === 'Midfielder') _this2.data.teams.filteredSquad.midfielder.push(item);
            if (item.position === 'Attacker') _this2.data.teams.filteredSquad.attacker.push(item);
            if (item.role === 'COACH') _this2.data.teams.filteredSquad.coach.push(item);
          }); // data untuk match


          _this2.data.teams.matches = response[1].matches;
          resolve(_this2.data.teams);
        }).catch(function (error) {
          return reject(error);
        });
      });
...
exports.default = FootballController;
},{"../api":"api.js","../helper":"helper.js"}],"../node_modules/notyf/notyf.es.js":[function(require,module,exports) {
"use strict";
...
exports.Notyf = Notyf;
},{}],"controllers/UICtrl.js":[function(require,module,exports) {
"use strict";
...
var UIController = /*#__PURE__*/function () {
  ...
  _createClass(UIController, [{
    ...
    key: "selectAll",
    value: function selectAll(item) {
      return document.querySelectorAll(item);
    }
  }, {
    key: "showNotyf",
    value: function showNotyf(message, type) {
    ...
    key: "injectStandingToTable",
    value: function injectStandingToTable(standing) {
      var html = "";
      standing.table.forEach(function (item) {
        html += "\n        <tr>\n          <td>".concat(item.position, "</td>\n          <td><img src=\"").concat(item.team.crestUrl, "\" height=\"30\" alt=\"Avatar Team\"></td>\n          <td><a href=\"#detail?id=").concat(item.team.id, "\">").concat(item.team.name, "</a></td>\n          <td>").concat(item.playedGames, "</td>\n          <td>").concat(item.won, "</td>\n          <td>").concat(item.draw, "</td>\n          <td>").concat(item.lost, "</td>\n          <td>").concat(item.goalsFor, "</td>\n          <td>").concat(item.goalsAgainst, "</td>\n          <td>").concat(item.goalDifference, "</td>\n          <td>").concat(item.points, "</td>\n        </tr>\n      ");
      });
      this.select('#standing').innerHTML = html;
    }
  }, {
    key: "injectCompetitionList",
    value: function injectCompetitionList(competition, season) {
      var html = "\n      <li class=\"collection-item\">\n        Kompetitsi ".concat(competition.name, " (").concat(competition.code, ")\n      </li>\n      <li class=\"collection-item\">Negara: ").concat(competition.area.name, "</li>\n      <li class=\"collection-item\">Tanggal Dimulai: ").concat(season.startDate, "</li>\n      <li class=\"collection-item\">Tanggal Berakhir: ").concat(season.endDate, "</li>\n      <li class=\"collection-item\">Minggu Ke: ").concat(season.currentMatchday, "</li>\n      <li class=\"collection-item\">Pemenang: ").concat(season.winner === null ? "Belum Diketahui" : season.winner, "</li>\n    ");
      this.select('#competition').innerHTML = html;
    }
  }, {
    key: "injectListTeam",
    value: function injectListTeam(position) {
      var teamHtml = "";
      position.forEach(function (item) {
        teamHtml += "\n        <div class=\"flex__item center-align\">\n          <div class=\"number\">".concat(item.shirtNumber !== null ? item.shirtNumber : 'N/A', "</div>\n          <h6>").concat(item.name, "</h6>\n          <p class=\"text\">").concat(item.nationality, "</p>\n        </div>\n      ");
      });
      return teamHtml;
    }
  }, {
    key: "injectTeam",
    value: function injectTeam(result) {
      var team = result;
      var activeCompetition = '';
      team.activeCompetitions.forEach(function (item, id, team) {
        activeCompetition += "".concat(id !== team.length - 1 ? "".concat(item.name, ", ") : "".concat(item.name));
      });
      var nameTeamHtml = "".concat(team.name);
      var detailTeamHtml = "\n      <li class=\"collection-item\">Stadion: ".concat(team.venue, "</li>\n      <li class=\"collection-item\">Berdiri: ").concat(team.founded, "</li>\n      <li class=\"collection-item\">Warna Klub: ").concat(team.clubColors, "</li>\n      <li class=\"collection-item\">Kompetisi diikuti: ").concat(activeCompetition, "</li>\n      <li class=\"collection-item\">Website: ").concat(team.website !== null ? "<a href=".concat(team.website, " target=\"_blank\">").concat(team.website, "</a>") : 'N/A', "</li>\n      <li class=\"collection-item\">Email: ").concat(team.email, "</li>\n    ");
      var imgTeam = "<img src=\"".concat(team.crestUrl, "\" alt=\"Image Team\">");
      var listTeam = "\n      <div class=\"col s12\">\n        <h5>Kiper</h5>\n\n        <div class=\"flex\">\n          ".concat(this.injectListTeam(team.filteredSquad.goalkeeper), "\n        </div>\n      </div>\n      <div class=\"col s12\">\n        <h5>Pemain Bertahan</h5>\n\n        <div class=\"flex\">\n          ").concat(this.injectListTeam(team.filteredSquad.defender), "\n        </div>\n      </div>\n      <div class=\"col s12\">\n        <h5>Pemain Tengah</h5>\n\n        <div class=\"flex\">\n          ").concat(this.injectListTeam(team.filteredSquad.midfielder), "\n        </div>\n      </div>\n\n      <div class=\"col s12\">\n        <h5>Penyerang</h5>\n\n        <div class=\"flex\">\n          ").concat(this.injectListTeam(team.filteredSquad.attacker), "\n        </div>\n      </div>\n\n      <div class=\"col s12\">\n        <h5>Pelatih/Manajer</h5>\n\n        <div class=\"flex\">\n          ").concat(this.injectListTeam(team.filteredSquad.coach), "\n        </div>\n      </div>\n    ");
      var matchTeam = "";
      team.matches.forEach(function (item, id) {
        id += 1;
        matchTeam += "\n        <tr>\n          <td>".concat(id, "</td>\n          <td>").concat(item.homeTeam.name, " VS ").concat(item.awayTeam.name, "</td>\n          <td>").concat((0, _helper.dateFormatter)(item.utcDate), "</td>\n        </tr>\n      ");
      });
    ...
    key: "injectSavedTeam",
    value: function injectSavedTeam(teams) {
      var listTeams = "";
      teams.forEach(function (team) {
        ...
        listTeams += "\n        <div class=\"col s12 l6\" data-id=\"".concat(team.id, "\">\n          <div class=\"card\">\n            <div class=\"card-image\">\n              <img src=\"").concat(team.crestUrl, "\" alt=\"").concat(team.shortName, "\" height=\"200\" width=\"100\">\n            </div>\n            <div class=\"card-content\">\n              <h5 class=\"card-title\">").concat(team.name, "</h5>\n              <ul class=\"collection\">\n                <li class=\"collection-item\">Alamat: ").concat(team.address, "</li>\n                <li class=\"collection-item\">Surel: ").concat(team.email, "</li>\n                <li class=\"collection-item\">Situs Web: ").concat(team.website, "</li>\n                <li class=\"collection-item\">Kompetisi diikuti: ").concat(activeCompetition, "</li>\n                <li class=\"collection-item\">Stadion: ").concat(team.venue, "</li>\n              </ul>\n            </div>\n            <div class=\"card-action\">\n              <a href=\"#detail?id=").concat(team.id, "&saved=true\" class=\"waves-effect waves-teal btn-flat light-blue white-text detail\">Detail</a>\n              <a href=\"#\" class=\"waves-effect waves-teal btn-flat red white-text delete\">Hapus</a>\n            </div>\n          </div>\n        </div>\n      ");
      });
...
},{"../helper":"helper.js","notyf":"../node_modules/notyf/notyf.es.js"}],"../node_modules/idb/lib/idb.js":[function(require,module,exports) {
'use strict';
...
},{}],"controllers/DBCtrl.js":[function(require,module,exports) {
"use strict";
...
var DBController = /*#__PURE__*/function () {
  function DBController() {
    _classCallCheck(this, DBController);

    this.db = _idb.default.open('football-pwa', 1, function (upgradeDB) {
      var objectStoreTeams = upgradeDB.createObjectStore('teams', {
        keyPath: 'id'
      });
      objectStoreTeams.createIndex('squad', 'squad', {
        unique: false
      });
    });
  }
  ...
  _createClass(DBController, [{
    key: "saveData",
    value: function saveData(data, objectStore) {
      var _this = this;
    ...
    key: "getAllData",
    value: function getAllData(objectStore) {
      var _this2 = this;
    ...
    key: "getDataById",
    value: function getDataById(id, objectStore) {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        _this3.db.then(function (db) {
    ...
    key: "deleteData",
    value: function deleteData(id, objectStore) {
      var _this4 = this;
...
},{"idb":"../node_modules/idb/lib/idb.js"}],"controllers/AppCtrl.js":[function(require,module,exports) {
"use strict";
...
var _FootballCtrl = _interopRequireDefault(require("./FootballCtrl"));

var _UICtrl = _interopRequireDefault(require("./UICtrl"));

var _DBCtrl = _interopRequireDefault(require("./DBCtrl"));
...
var AppController = /*#__PURE__*/function () {
  function AppController() {
    ...
    this.UI = new _UICtrl.default();
    this.Football = new _FootballCtrl.default();
    this.init();
  }
  ...
  _createClass(AppController, [{
    key: "init",
    value: function init() {
      M.Sidenav.init(this.UI.getSelector.sidenav, {
        menuWidth: 300,
        // Default is 300
        edge: 'left',
      ...
      this.loadNav();
      var hash = window.location.hash.split('?')[0].substr(1);
      if (hash == '') hash = 'home';
      this.loadPage(hash);
      this.db = new _DBCtrl.default();
    }
  }, {
    key: "loadNav",
    value: function loadNav() {
      ...
      (0, _api.ajax)('nav.html').then(function (menu) {
        ...
        if (hash !== 'detail') {
          var linkActiveDefault = document.querySelector("a[href*=\"".concat(hash, "\"]"));
          linkActiveDefault.parentElement.classList.add('active');
        }

        _this.UI.selectAll('.sidenav a, .topnav a').forEach(function (link) {
          // tentukan link aktif
          ...
          link.addEventListener('click', function (event) {
            ...
            event.target.parentElement.classList.add('active'); // inisiasi kembali

            activeLink = [];
            activeLink.push(event.target); // tutup sidenav

            var sidenav = _this.UI.getSelector.sidenav;
      ...
      (0, _api.ajax)("pages/".concat(url, ".html")).then(function (page) {
        ...
        if (url === 'home') {
          try {
            ...
            _this2.UI.select("#standing").addEventListener('click', function (event) {
              var page = event.target.getAttribute('href').split('?')[0].substr(1);
          ...
          try {
            _this2.renderDataDetail();
          } catch (error) {
            console.log(error);
          }
        } else if (url === 'favorite') {
          _this2.renderDataSaved();

          window.setTimeout(function () {
            _this2.UI.selectAll('#favoriteTeam a.detail').forEach(function (favorite) {
            ...
            _this2.UI.selectAll('#favoriteTeam a.delete').forEach(function (deleteItem) {
              deleteItem.addEventListener('click', function (event) {
                ...
                if (confirm('Apakah anda ingin menghapus tim dari favorit')) {
                  ...
                  _this2.deleteDataFromDB(target.dataset.id);
                } else {
                  return;
                }
              });
        ...
        _this2.UI.getSelector.content.innerHTML = "Oooppps Halaman tidak ditemukan";
      });
    }
  }, {
    key: "renderData",
    value: function renderData() {
      ...
      // dapatkan data
      this.Football.fetchDataCompetition().then(function (result) {
        // inject table
        _this3.UI.injectStandingToTable(result.standing); // inject competition


        _this3.UI.injectCompetitionList(result.competition, result.season);
      }).catch(function (error) {
        return console.error(error);
      });
    }
  }, {
    key: "renderDataDetail",
    value: function renderDataDetail() {
      var _this4 = this;

      // dapatkan id team
      var params = window.location.hash.split('?')[1];
      var urlParams = new URLSearchParams("?".concat(params));
      ...
      if (isFromSaved) {
        ...
        this.db.getDataById(id, 'teams').then(function (team) {
          ...
          _this4.UI.injectTeam(team);
        });
      } else {
        // dapatkan data
        this.Football.fetchDataTeam(id).then(function (team) {
          // inject data pemain
          _this4.UI.injectTeam(team); // save data ke indexedDB


          _this4.UI.select('#floatButton').addEventListener('click', function () {
            _this4.db.saveData(team, 'teams').then(function (result) {
              _this4.UI.showNotyf('Berhasil menambahkan tim ke favorit', 'info');
            }).catch(function (error) {
              _this4.UI.showNotyf('Gagal menambahkan tim ke favorit, sepertinya sudah ditambahkan', 'error');
    ...
    key: "renderDataSaved",
    value: function renderDataSaved() {
      var _this5 = this;

      this.db.getAllData('teams').then(function (team) {
        // show Loading
        (0, _helper.showLoading)(); // inject team ke halaman favorite

        _this5.UI.injectSavedTeam(team);
      }).catch(function (error) {
        return console.log(error);
      });
    }
  }, {
    key: "deleteDataFromDB",
    value: function deleteDataFromDB(id) {
      var _this6 = this;

      // rubah string ke integer
      id = parseInt(id); // hapus data dari indexedDB

      this.db.deleteData(id, 'teams').then(function (status) {
        _this6.UI.showNotyf("Berhasil menghapus data", 'info');
...
},{"./FootballCtrl":"controllers/FootballCtrl.js","./UICtrl":"controllers/UICtrl.js","./DBCtrl":"controllers/DBCtrl.js","../helper":"helper.js","../api":"api.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _AppCtrl = _interopRequireDefault(require("./controllers/AppCtrl"));
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', function () {
    navigator.serviceWorker.register("/service-worker.js").then(function () {
      ...
      return console.log("Pendaftaran service worker gagal");
    });
  });
} else {
            ...
            if ('PushManager' in window) {
              navigator.serviceWorker.getRegistration().then(function (registration) {
                registration.pushManager.subscribe({
                  ...
                  applicationServerKey: (0, _helper.urlBase64ToUint8Array)('BMIEtTX1fDolDEh4vdCPI24jTcGWAsKW5g3-9vbuYVslrv4bhRsf4dywTs0OK4NL199KPP5GZRQTIHV2iJ1ejoQ')
                }).then(function (subscribe) {
                  console.log("Berhasil melakukan subscribe dengan endpoint: ".concat(subscribe.endpoint));
                  console.log("Berhasil melakukan subscribe dengan p256dh: ".concat(btoa(String.fromCharCode.apply(null, new Uint8Array(subscribe.getKey('p256dh'))))));
                  console.log("Berhasil melakukan subscribe dengan auth key: ".concat(btoa(String.fromCharCode.apply(null, new Uint8Array(subscribe.getKey('auth'))))));
                }).catch(function (error) {
                  return console.log("Tidak dapat melakukan subscribe ".concat(error.message));
                });
              });
            }
          });
